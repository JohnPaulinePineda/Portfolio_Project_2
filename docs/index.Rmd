...
# **1. Table of Contents**
|
| This document presents a non-exhaustive list of various data quality assessment, preprocessing and exploration methods for a regression modelling problem using various helpful packages in <mark style="background-color: #CCECFF">**R**</mark>.    
|
##  1.1 Sample Data
|
